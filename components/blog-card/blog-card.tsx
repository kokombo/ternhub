  ...
  return (
    <article className="max-w-[400px] sm:max-w-[295px] border-grey border-[0.8px] rounded-[10px]">
      ...
      <div className=" lg:h-[300px] p-[10px] flex_start gap-2">
        <p className="text-purple text-base" style={Grotesk.style}>
          {props.category}
        </p>

        <h4
          className="text-[22px] h-[68px] lg:text-2xl tracking-[1%] capitalize flex-wrap overflow-hidden"
          style={Grotesk.style}
        >
          {props.title}
        </h4>
        ...
        <p className="text-sm lg:text-base tracking-[1%] my-1 lg:h-[84px] h-[56px] flex-wrap overflow-hidden font-sans">
